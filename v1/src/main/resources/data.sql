...
INSERT INTO usuario (rut, nombre, email, contrasena, telefono, fecha_nac, rol) VALUES
('11.111.111-1', 'Test User', 'test@example.com', 'password123', '+56911111111', '1990-01-01', 'user'),
('22.222.222-2', 'Admin User', 'admin@example.com', 'admin123', '+56922222222', '1985-06-15', 'admin'),
('33.333.333-3', 'Finanzas User', 'finanzas@example.com', 'finanzas123', '+56933333333', '1992-03-20', 'finanzas');
...
INSERT INTO servicio (id, nombre, tipo, descripcion, precio) VALUES
(4, 'Firma Electrónica Avanzada - e-token', 'Avanzada', 'Firma Portable que queda almacenada en un dispositivo e-token. La Firma Electrónica e-token permite firmar documentos legales con valor probatorio. Agiliza la Contratación de Servicios y Firmas de Documentos. Optimiza procesos empresariales con plena validez legal. Requiere Enrolamiento presencial en sucursales o remoto. Si ya tiene E-token según normativa vigente modelos Safenet 5110 o 5110+, no requiere comprar otro.', 21990)
ON DUPLICATE KEY UPDATE nombre=VALUES(nombre);
...
INSERT INTO servicio (id, nombre, tipo, descripcion, precio) VALUES
(6, 'Firma Electrónica Online - Empresa en un Día', 'Online', 'Permite a personas naturales realizar el proceso de "Tu Empresa en un Día". Compra 100% online con ClaveÚnica y Cédula de Identidad Vigente. Es el primer paso para Formalizar tu Empresa. Te permite firmar en Empresa en un Día. Solución Rápida y Eficiente para iniciar tu propio negocio. Una vez constituida tu empresa el SII te asignará un RUT.', 798)
ON DUPLICATE KEY UPDATE nombre=VALUES(nombre);
